...
PARAM$final_train  <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009 )

PARAM$train$training     <- c( 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007)
