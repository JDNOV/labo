...
PARAM  <- list()
PARAM$experimento <- "DTJ2-TS6410B"

PARAM$exp_input  <- "DTJ2-FE6310B"
...
dir.create( paste0( "./exp/EXP.COLAB.202109/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp/EXP.COLAB.202109/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
